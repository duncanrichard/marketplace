...
<div class="card shadow-sm rounded p-4 mb-4">
    <div class="row">
        ...
        <div class="col-md-3 text-center border-end">
            ...
            <span class="badge bg-primary">No CM: {{ $pasien->no_cm }}</span>
            <div class="mt-2">
                <label class="fw-bold d-block text-center mb-1">Datang Telatan</label>
            ...
            <div class="mt-2">
                <label class="fw-bold d-block text-center mb-1">Status Dilayani</label>
                <div class="text-center">
    ...
    <div class="p-3 rounded bg-warning-subtle border border-warning text-dark fw-semibold fs-6">
        {{ $pasien->keterangan ?? 'Tidak ada keterangan.' }}
    </div>
</div>
...
<div class="card-style-3 mb-30">
    <div class="card-content">
        <form action="{{ route('reservasi.store') }}" method="POST">
            ...
            <input type="hidden" name="status_reservasi" value="Booked">
            <div class="mb-3">
                <label class="form-label fw-bold">Tanggal Reservasi</label>
               <input type="date" name="tanggal_reservasi" class="form-control" min="{{ date('Y-m-d') }}" required>
            </div>
            <div class="mb-3">
                <label class="form-label fw-bold">Jam Reservasi</label>
